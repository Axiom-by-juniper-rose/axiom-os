...
const JURIS_DATA: Record<string, StateData> = {
    ...
    CO: {
        ...
        tips: ["Water rights are separate from land rights — purchase water or prove augmentation BEFORE major investment.", "Wildfire: WUI development adds $20,000–60,000/lot for fire mitigation.", "Metro Districts: Special district formation for infrastructure finance common on Front Range."]
    },
    NV: {
        ...
        tips: ["BLM Land Auctions (SNPLMA): Major way land is acquired given fed ownership. Cash intensive.", "Water is EVERYTHING. Verify commitment from SNWA/TMWA before any non-refundable money goes hard.", "Dust control enforcement is severe; factor water truck costs into site prep."]
    },
    PA: {
    ...
    GA: {
        ...
        tips: ["Stream buffers are a major constraint — map all state waters early with GIS and field survey.", "Traffic studies triggered at 100+ peak hour trips.", "Forsyth/Cherokee: Explosive growth counties. Entitlement timelines stretch due to workload."]
    },
    NC: {
        ...
        tips: ["Conditional Zoning: CD rezonings come with binding conditions — negotiate carefully.", "Jordan Lake buffer: Major constraint in Chatham, Orange, Durham, Wake counties.", "Vested rights: NC 160D-108.1 provides 5-year vested right upon approved preliminary subdivision plat."]
    },
    TN: {
        ...
        tips: ["Karst study: Required in Middle TN limestone areas. Budget $15,000–40,000 for survey + borings.", "Rural TN: Fast approvals possible due to lack of county zoning.", "Nashville MSA: Explosive growth. Williamson County is highly competitive."]
    }
};
