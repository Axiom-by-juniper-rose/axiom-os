 ...
 * Placeholder until @react-three/fiber / three are installed.
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        color: C.textMid, fontFamily: 'DM Mono, monospace', fontSize: 12, flexDirection: 'column', gap: 8,
      }}>
        <span style={{ fontSize: 28 }}>🗺</span>
        <span>3D Map — install @react-three/fiber to enable</span>
      </div>
